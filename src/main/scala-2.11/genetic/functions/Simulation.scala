...
object Simulation {
  ...
  def simulate(listLength: Int, listsPopulationSize: Int, networksPopulationSize: Int, startingNetworkSize: Int, numberOfSteps: Int, strategy: Strategy[SortingNetwork,ListToSort]) = {
